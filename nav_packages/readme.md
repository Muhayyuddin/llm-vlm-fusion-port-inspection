...
```
```
ros2 launch mbzirc_ign spawn.launch.py name:=usv world:=coast model:=usv x:=-1450 y:=-16.5 z:=0.3 R:=0 P:=0 Y:=0  slot0:=mbzirc_rgbd_camera  slot0_rpy:="0 -14 0" slot4:=mbzirc_planar_lidar 

ros2 launch mbzirc_ign spawn.launch.py name:=usv world:=simple_demo_llm model:=usv type:=usv x:=15 y:=0 z:=0.3 R:=0 P:=0 Y:=0 slot0:=mbzirc_hd_camera  slot0_rpy:="0 -14 0" 
```
```
...
ros2 launch mbzirc_ign spawn.launch.py name:=usv world:=simple_demo model:=usv type:=usv x:=15 y:=0 z:=0.3 R:=0 P:=0 Y:=0 slot0:=mbzirc_hd_camera  slot0_rpy:="0 -14 0"

ros2 run usv_control pid_controller
